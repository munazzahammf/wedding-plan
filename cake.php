...
<body>
   ...
   <!-- photography section start -->
                 ...
                 <section class="photography">
                  <div class="para">
                  <p>Welcome to the sweetest corner of the wedding world!</p>
                  </div>
                           ...
                           <div class="card-inner">
                              <div class="front1">
                                 ...
                                 <div class="back">
                                    ...
                                    <h1>Robat Hardik<span>Cake Baker</span></h1>
                                    <p>I'm the Cake Baker Currently work <span>@DreamDay</span> Company</p>
                                    <div class="row">
                                       <div class="col">
                                          <h2>5K</h2>
                                          <p>Likes</p>
...
<section class="our-team">
        <div class="title">
                   <h1>Cake Team</h1>
                   <h5>Welcome to the world of our talented cake making team! With their artistic vision and 
                     exceptional baking skills, they are here to create exquisite cake masterpieces that will 
                     be the highlight of your wedding celebration.Each member of our cake making team brings a 
                     passion for the art of cake design and a dedication to delivering a sweet experience that 
                     surpasses your expectations. From elegant tiered cakes to intricately decorated creations, 
                     they have a knack for bringing your cake dreams to life.</h5>
