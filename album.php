...
<body>
   ...
   <!-- photography section start -->
                 ...
                 <section class="photography">
                  <div class="para">
                  <p>Welcome to the world of priceless memories and heartfelt moments!</p>
                  </div>
                           ...
                           <div class="card-inner">
                              <div class="front1">
                                 ...
                                 <div class="back">
                                    ...
                                    <h1>Robat Hardik<span>Album Designer</span></h1>
                                    <p>I'm the Album Designer Currently work <span>@DreamDay</span> Company</p>
                                    <div class="row">
                                       <div class="col">
                                          <h2>5K</h2>
                                          <p>Likes</p>
...
<section class="our-team">
        <div class="title">
                   <h1>Wedding Album Team</h1>
                     <h5>Welcome to the world of our dedicated and talented free wedding album team! With their 
                     passion for photography and storytelling, they are here to capture and preserve the precious 
                     moments of your special day.Each member of our team brings a creative eye and a commitment 
                     to excellence. They understand the significance of your wedding day and the importance of 
                     preserving the memories that will last a lifetime. With their expertise, they beautifully 
                     document every detail, every smile, and every heartfelt emotion, creating a visual narrative 
                     that tells your unique love story.</h5>
                   </div>
            <div class="main">
