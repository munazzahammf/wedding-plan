...
<body>
   ...
   <!-- photography section start -->
                 ...
                 <section class="photography">
                  <div class="para">
                  <p>Welcome to the enchanting world of wedding entertainment!</p>
                  </div>
...
<section class="our-team">
        <div class="title">
                   <h1>Entertainment Team</h1>
                   <h5>Welcome to the world of our talented and passionate wedding entertainment team! With their 
                     energy and enthusiasm, they are here to create unforgettable moments and keep the celebration 
                     alive throughout your special day.Each member of our team brings their unique talent and 
                     expertise to the stage, whether it's through live music, DJ services, or captivating 
                     performances. They understand the power of music and entertainment in setting the mood, 
                     creating a vibrant atmosphere, and bringing people together.</h5>
